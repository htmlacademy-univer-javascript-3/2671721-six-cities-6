...
import {
  getActiveCity,
  getActiveSortingType, getIsError,
  getIsLoading,
  getPlaceCards
...
vi.mock('../sorted-select/sorted-select', () => ({
...
vi.mock('../location-list/location-list', () => ({
  MemorizedLocationList: vi.fn(() => <div data-testid="location-list">Location List</div>)
}));
